...
class Main extends JFrame implements MouseListener {
  public static JFrame frame_game;
...
Main.frame_game.setBounds(0, 0,  (int)size.getWidth()+1,  (int)size.getHeight()+1);
        Main.dc.repaint();
    }
    ...
    public static void main(String[] args) {
        ...
        Main.frame_game = new JFrame("game");
        Main.frame_game.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        Main.frame_game.setSize(Main.max_bounds + Main.max_radius + 100, Main.max_bounds + Main.max_radius + 100);
      Main.frame_game.setExtendedState(JFrame.MAXIMIZED_BOTH);
        ...
        try {
            ...
            start_B.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    Main.frame_game.setVisible(true);
                  ...
                  Main.round = 0;
                    ...
                    Main.dc.add(label);
                    Main.frame_game.add(Main.dc);
                    Main.frame_game.addMouseListener(m);
                  Main.frame_game.setExtendedState(JFrame.MAXIMIZED_BOTH);
                }
            });
            // restart game
...
Main.frame_game.setBounds(0, 0,  (int)size.getWidth()+1,  (int)size.getHeight()+1);
                ...
                if (Main.round > 10 || time_ex) {
                    ...
                    JOptionPane.showMessageDialog(Main.frame_game,"GAME OVER");
                    break;
                }
                System.out.println("nextround");
            }
            frame_menu.setVisible(true);
            Main.frame_game.setVisible(false);
            try {
                Thread.sleep(1500);
            } catch (Exception ex) {
